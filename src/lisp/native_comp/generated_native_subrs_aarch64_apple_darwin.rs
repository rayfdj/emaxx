...
pub(crate) static NATIVE_SUBRS: [NativeSubr; 1445] = [
    NativeSubr::new(
        c"json-parse-buffer",
        0,
        NativeMaxArgs::Many,
    ...
    NativeSubr::new(
        c"ns-disown-selection-internal",
        1,
        NativeMaxArgs::Fixed(1),
    ...
    NativeSubr::new(
        c"ns-mouse-absolute-pixel-position",
        0,
        NativeMaxArgs::Fixed(0),
    ...
    NativeSubr::new(
        c"ns-set-mouse-absolute-pixel-position",
        2,
        NativeMaxArgs::Fixed(2),
    ...
    NativeSubr::new(
        c"ns-display-monitor-attributes-list",
        0,
        NativeMaxArgs::Fixed(1),
    ...
    NativeSubr::new(
        ...
        0,
        NativeMaxArgs::Fixed(0),
        native_subr_1076 as *const std::ffi::c_void,
        1076,
    ),
    NativeSubr::new(
    ...
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1152 as *const std::ffi::c_void,
        1152,
    ),
    NativeSubr::new(
        c"fillarray",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(2),
        native_subr_1168 as *const std::ffi::c_void,
        1168,
    ),
    NativeSubr::new(
        c"assoc",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(2),
        native_subr_1171 as *const std::ffi::c_void,
        1171,
    ),
    NativeSubr::new(
        c"memq",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(2),
        native_subr_1175 as *const std::ffi::c_void,
        1175,
    ),
    NativeSubr::new(
        c"nthcdr",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(2),
        native_subr_1216 as *const std::ffi::c_void,
        1216,
    ),
    NativeSubr::new(
        c"puthash",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(3),
        native_subr_1218 as *const std::ffi::c_void,
        1218,
    ),
    NativeSubr::new(
        c"clrhash",
    ...
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1301 as *const std::ffi::c_void,
        1301,
    ),
    NativeSubr::new(
        c"symbol-name",
    ...
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1319 as *const std::ffi::c_void,
        1319,
    ),
    NativeSubr::new(
        c"subrp",
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1320 as *const std::ffi::c_void,
        1320,
    ),
    NativeSubr::new(
        c"markerp",
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1321 as *const std::ffi::c_void,
        1321,
    ),
    NativeSubr::new(
        c"bufferp",
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1322 as *const std::ffi::c_void,
        1322,
    ),
    NativeSubr::new(
        c"sequencep",
    ...
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1346 as *const std::ffi::c_void,
        1346,
    ),
    NativeSubr::new(
        c"type-of",
    ...
    NativeSubr::new(
        ...
        2,
        NativeMaxArgs::Fixed(4),
        native_subr_1353 as *const std::ffi::c_void,
        1353,
    ),
    NativeSubr::new(
        c"posn-at-point",
        0,
        NativeMaxArgs::Fixed(2),
        native_subr_1354 as *const std::ffi::c_void,
        1354,
    ),
    NativeSubr::new(
        ...
        0,
        NativeMaxArgs::Fixed(0),
        native_subr_1355 as *const std::ffi::c_void,
        1355,
    ),
    NativeSubr::new(
        c"set-input-mode",
        3,
        NativeMaxArgs::Fixed(4),
        native_subr_1356 as *const std::ffi::c_void,
        1356,
    ),
    NativeSubr::new(
        c"set-quit-char",
    ...
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(2),
        native_subr_1358 as *const std::ffi::c_void,
        1358,
    ),
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(2),
        native_subr_1359 as *const std::ffi::c_void,
        1359,
    ),
    NativeSubr::new(
        ...
        1,
        NativeMaxArgs::Fixed(1),
        native_subr_1360 as *const std::ffi::c_void,
        1360,
    ),
    NativeSubr::new(
        c"open-dribble-file",
