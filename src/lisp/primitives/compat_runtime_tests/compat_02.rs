...
fn value_less_selected_upstream_ordered_cases_match_emacs() {
    ...
    for (label, left, right) in cases {
        ...
        let vector_forward = call(
            ...
            "value<",
            &[
                Value::vector([left.clone(), Value::Integer(2)]),
                Value::vector([right.clone(), Value::Integer(1)]),
            ],
            &mut env,
        )
        ...
        let same_left = call(
            ...
            "value<",
            &[
                Value::vector([left.clone(), Value::Integer(1)]),
                Value::vector([left.clone(), Value::Integer(2)]),
            ],
            &mut env,
        )
        ...
        let same_right = call(
            ...
            &[
                Value::vector([right.clone(), Value::Integer(1)]),
                Value::vector([right, Value::Integer(2)]),
            ],
            &mut env,
        )
